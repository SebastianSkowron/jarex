...
export const About = () => {
  ...
  return (
    <div className="mt-20 md:mt-40 text-center lg:text-left bg-[#f7f7f7] rounded-lg mb-10 md:mb-24 px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
